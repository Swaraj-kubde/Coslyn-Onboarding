          ...
          <CardContent className="p-8 md:p-12">
            <div className="text-center mb-10">
              ...
              <p className="text-blue-200 text-lg">
                Tell us about your challenges and let's build your AI-powered
                solution together.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    onChange={(e) =>
                      handleInputChange("currentChallenge", e.target.value)
                    }
              ...
              <div className="space-y-6">
                <DateTimePicker
                  ...
                  onChange={(date) =>
                    handleInputChange("meetingDateTime", date)
                  }
                />
              </div>
              ...
              <div className="pt-6">
                ...
                <div className="text-center mt-4">
                  <p className="text-xs text-blue-200 flex items-center justify-center gap-1">
                    ...
                    you about AI automation solutions.
                  </p>
                </div>
              </div>
            </form>
